...
# myToken = "xoxb-3643582036066-3643637206146-sV77llZQdfhgIKozF6xIKBMi"
...
class stockInfo():
    ...
    def get_stock_info(self):
        ...
        # 현재가 객체 구하기
        inputInfo = 'A000020'
        # inputInfo = input('종목 코드를 입력해주세요: ')
        objStockMst = win32com.client.Dispatch("DsCbo1.StockMst")
        objStockMst.SetInputValue(0, inputInfo)   #종목 코드 - 삼성전자
        ...
        asd = f'{code}, {name}, 시가: {open}, 고가: {high}'
        
        # post_message(myToken,"#current_price", asd)
        return Post().post_message('#sj', asd)
