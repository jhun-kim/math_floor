...
g_objCodeMgr = win32com.client.Dispatch('CpUtil.CpCodeMgr') # 각종코드정보및코드리스트를얻을수있습니다.
g_objCpStatus = win32com.client.Dispatch('CpUtil.CpCybos')  #매수매도 오브젝
g_objCpTrade = win32com.client.Dispatch('CpTrade.CpTdUtil') # 주문을 위해 초기화 과정 수행
