...
class CpStockChart: # 차트 데이터 수신
    def __init__(self):
        ...
        self.objStockChart = win32com.client.Dispatch("CpSysDib.StockChart") # 차트 기본 데이터 수신(ohlc)
...
class CpStockCur:
    def Subscribe(self, code, objIndex):
        self.objStockCur = win32com.client.Dispatch("DsCbo1.StockCur") # 현재가 실시간 데이터 수신
...
class MyWindow(QMainWindow):
    ...
    def btnStart_clicked(self):
        ...
        self.objSeries = win32com.client.Dispatch("CpIndexes.CpSeries") #차트 지표 계산을 위한 중간 오브젝
    ...
    def makeMACD(self):
        ...
        #실질적인 지표 계산 오브젝으로 macd, 이동편균, cci, sotchastic등 다양한 지표 계산 및 시그널 발생도 가능 
